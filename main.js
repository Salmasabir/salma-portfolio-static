...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      skillsTitle: "Skills",
      pathTitle: "Path",
      pathText: "Here is my academic and professional background:",
      ...
      projectTitle: "Projects",
       projectText1: "Recipe Site Web With HTML, CSS, JS",
      projectText2:"Personal Portfolio With HTML, CSS, JS",
    ...
    fr: {
      ...
      projectText1: "Site Web de recettes avec HTML, CSS, JS",
      projectText2:"Portfolio Personel avec HTML, CSS, JS",
      contactTitle: "Contact",
